...
namespace LibraRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20240813032704_Reservation-FK-With-Store")]
    partial class ReservationFKWithStore
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumberId = 1,
                            StoreId = new Guid("694a1bdf-828c-401c-841d-f0caeba479e6")
                        });
                });
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CreatedAt = new DateTime(2024, 8, 13, 10, 27, 3, 973, DateTimeKind.Local).AddTicks(1393),
                            Deleted = false,
                            Id = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.OrderHeader", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = new Guid("f069e54c-b5f4-416b-8c7a-f4d22e566e60"),
                            CashierId = new Guid("e1b57137-bf14-4e95-8848-216b7bcb2bc7"),
                            Deleted = false,
                            Id = new Guid("f069e54c-b5f4-416b-8c7a-f4d22e566e60"),
                            IsCanceled = false,
                            IsCompleted = false,
                            IsPaid = false,
                            ...
                            ReadyTime = new DateTime(2024, 8, 13, 10, 27, 3, 973, DateTimeKind.Local).AddTicks(7288),
                            ReservationId = 1,
                            ServantId = new Guid("fd69a161-2308-4d96-a985-8288c1f9a58a"),
                            StoreId = new Guid("f6f9658f-3bb2-4c61-8ee8-5cd7b203e8c4"),
                            Subtotal = 1000000.0,
                            Tax = 10.0,
                            Total = 1100000.0
                        });
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StoreId = new Guid("f069e54c-b5f4-416b-8c7a-f4d22e566e60"),
                            Address = "",
                            CityId = 1,
                            Deleted = false,
                            DistrictId = 1,
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredAt = new DateTime(2024, 8, 13, 10, 27, 3, 972, DateTimeKind.Local).AddTicks(9479),
                            Status = 0
                        });
                });
