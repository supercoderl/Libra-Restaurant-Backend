...
namespace LibraRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20240820135842_Foreign-Order-Menu")]
    partial class ForeignOrderMenu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CreatedAt = new DateTime(2024, 8, 20, 20, 58, 42, 69, DateTimeKind.Local).AddTicks(8896),
                            Deleted = false,
                            Id = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StoreId = new Guid("6dc57572-65dc-4594-87ee-d5c15e70f3ff"),
                            Address = "",
                            CityId = 1,
                            Deleted = false,
                            DistrictId = 1,
                            Id = new Guid("6dc57572-65dc-4594-87ee-d5c15e70f3ff"),
                            IsActive = true,
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredAt = new DateTime(2024, 8, 20, 20, 58, 42, 69, DateTimeKind.Local).AddTicks(6169),
                            Status = 0
                        });
                });
