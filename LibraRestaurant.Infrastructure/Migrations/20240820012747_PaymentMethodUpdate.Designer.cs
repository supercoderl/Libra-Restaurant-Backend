...
namespace LibraRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20240820012747_PaymentMethodUpdate")]
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumberId = 1,
                            StoreId = new Guid("4f142e81-1d7a-4ad7-956c-f393620bcf35")
                        });
                });
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CreatedAt = new DateTime(2024, 8, 20, 8, 27, 47, 489, DateTimeKind.Local).AddTicks(9470),
                            Deleted = false,
                            Id = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StoreId = new Guid("311b642e-663b-4ebc-86d6-473389edd053"),
                            Address = "",
                            CityId = 1,
                            Deleted = false,
                            DistrictId = 1,
                            Id = new Guid("311b642e-663b-4ebc-86d6-473389edd053"),
                            IsActive = true,
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredAt = new DateTime(2024, 8, 20, 8, 27, 47, 489, DateTimeKind.Local).AddTicks(7049),
                            Status = 0
                        });
                });
