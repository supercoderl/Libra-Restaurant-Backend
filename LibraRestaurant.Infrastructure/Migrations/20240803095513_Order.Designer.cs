...
namespace LibraRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20240803095513_Order")]
    partial class Order
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumberId = 1,
                            StoreId = new Guid("f46f849d-c345-4c17-a821-3cb1cf910b57")
                        });
                });
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CreatedAt = new DateTime(2024, 8, 3, 16, 55, 12, 22, DateTimeKind.Local).AddTicks(7857),
                            Deleted = false,
                            Id = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.OrderHeader", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = new Guid("26361ab2-1410-480d-98e2-d7b23ce84ee6"),
                            CashierId = new Guid("3a0d12b1-4867-4d3d-996a-52cc38feb2a9"),
                            Deleted = false,
                            Id = new Guid("26361ab2-1410-480d-98e2-d7b23ce84ee6"),
                            IsCanceled = false,
                            IsCompleted = false,
                            IsPaid = false,
                            ...
                            ReadyTime = new DateTime(2024, 8, 3, 16, 55, 12, 23, DateTimeKind.Local).AddTicks(1782),
                            ReservationId = 1,
                            ServantId = new Guid("55be38ae-3f3f-401d-bafb-bbcfe0677ba0"),
                            StoreId = new Guid("75bd5777-1737-4efa-9bde-5eeba646dc4b"),
                            Subtotal = 1000000.0,
                            Tax = 10.0,
                            Total = 1100000.0
                        });
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredAt = new DateTime(2024, 8, 3, 16, 55, 12, 22, DateTimeKind.Local).AddTicks(6409),
                            Status = 0
                        });
                });
