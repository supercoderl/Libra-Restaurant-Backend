...
namespace LibraRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20240801044643_check")]
    partial class check
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CreatedAt = new DateTime(2024, 8, 1, 11, 46, 42, 161, DateTimeKind.Local).AddTicks(7705),
                            Deleted = false,
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("92769c0d-50f6-4470-81b4-7ea6a5b4ee66"),
                            Deleted = false,
                            ...
                            RegisteredAt = new DateTime(2024, 8, 1, 11, 46, 42, 161, DateTimeKind.Local).AddTicks(6141),
                            Status = 0
                        });
                });
