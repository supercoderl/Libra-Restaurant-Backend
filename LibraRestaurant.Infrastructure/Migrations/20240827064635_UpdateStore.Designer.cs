...
namespace LibraRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20240827064635_UpdateStore")]
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CreatedAt = new DateTime(2024, 8, 27, 13, 46, 34, 330, DateTimeKind.Local).AddTicks(357),
                            Deleted = false,
                            Id = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aac7471d-a6f3-4525-bcd3-f53c6234c208"),
                            Deleted = false,
                            ...
                            RegisteredAt = new DateTime(2024, 8, 27, 13, 46, 34, 329, DateTimeKind.Local).AddTicks(7869),
                            Status = 0
                        });
                });
