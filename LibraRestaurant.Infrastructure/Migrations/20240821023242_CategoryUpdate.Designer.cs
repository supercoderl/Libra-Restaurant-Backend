...
namespace LibraRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20240821023242_CategoryUpdate")]
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CreatedAt = new DateTime(2024, 8, 21, 9, 32, 40, 127, DateTimeKind.Local).AddTicks(7369),
                            Deleted = false,
                            Id = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StoreId = new Guid("d61ac4b1-43b5-4cc4-a5d4-fed0687db08a"),
                            Address = "",
                            CityId = 1,
                            Deleted = false,
                            DistrictId = 1,
                            Id = new Guid("d61ac4b1-43b5-4cc4-a5d4-fed0687db08a"),
                            IsActive = true,
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredAt = new DateTime(2024, 8, 21, 9, 32, 40, 127, DateTimeKind.Local).AddTicks(4449),
                            Status = 0
                        });
                });
