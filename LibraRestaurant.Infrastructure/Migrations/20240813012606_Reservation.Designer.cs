...
namespace LibraRestaurant.Infrastructure.Migrations
{
    ...
    [Migration("20240813012606_Reservation")]
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumberId = 1,
                            StoreId = new Guid("1160416b-48e4-496a-98dc-23646d5e7487")
                        });
                });
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CreatedAt = new DateTime(2024, 8, 13, 8, 26, 6, 94, DateTimeKind.Local).AddTicks(4201),
                            Deleted = false,
                            Id = new Guid("00000000-0000-0000-0000-000000000000"),
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.OrderHeader", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = new Guid("0d9d0716-9db9-4770-9a11-c926f60eaa34"),
                            CashierId = new Guid("1c5561fb-7227-47df-9598-54a989ccd32c"),
                            Deleted = false,
                            Id = new Guid("0d9d0716-9db9-4770-9a11-c926f60eaa34"),
                            IsCanceled = false,
                            IsCompleted = false,
                            IsPaid = false,
                            ...
                            ReadyTime = new DateTime(2024, 8, 13, 8, 26, 6, 95, DateTimeKind.Local).AddTicks(36),
                            ReservationId = 1,
                            ServantId = new Guid("2ba1215c-ff61-4c27-b5f8-74a9715f33b0"),
                            StoreId = new Guid("c96c1fd7-978d-4233-ab01-8719d4aa1ca8"),
                            Subtotal = 1000000.0,
                            Tax = 10.0,
                            Total = 1100000.0
                        });
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StoreId = new Guid("0d9d0716-9db9-4770-9a11-c926f60eaa34"),
                            Address = "",
                            CityId = 1,
                            Deleted = false,
                            DistrictId = 1,
            ...
            modelBuilder.Entity("LibraRestaurant.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredAt = new DateTime(2024, 8, 13, 8, 26, 6, 94, DateTimeKind.Local).AddTicks(1790),
                            Status = 0
                        });
                });
